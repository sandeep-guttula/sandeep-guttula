...
like a terminal, then holds. GitHub renders SVG animations via SMIL inside <img>.
"""
...
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(HERE, "..", "sandeep-ascii.svg")
...
parts.append(
    ...
    f'text-anchor="middle">sandeep@github: ~$ ./portrait.sh</text>'
)
...
parts.append(
    ...
    f'sandeep@github:~$ whoami <tspan fill="{INK}">Sandeep Guttula</tspan></text>'
)
parts.append(
    f'<rect x="{PAD+280}" y="{status_y-12:.1f}" width="8" height="14" fill="{INK}">'
